...
public class DinamicBar extends CoordinatorLayout {
    ...
    CoordinatorLayout.LayoutParams nestedScrollParams;
    ...
    public DinamicBar(Context context, DisplayMetrics met) {
        ...
        ///////////////////////////////////////////////////////////////
        nestedScrollParams = new CoordinatorLayout.LayoutParams(
    ...
    public CoordinatorLayout.LayoutParams getNestedScrollParams() {
